...
CREATE TABLE IF NOT EXISTS "Lettings_address" ("id" integer NOT NULL PRIMARY KEY , "number" integer unsigned NOT NULL CHECK ("number" >= 0), "street" varchar(64) NOT NULL, "city" varchar(64) NOT NULL, "state" varchar(2) NOT NULL, "zip_code" integer unsigned NOT NULL CHECK ("zip_code" >= 0), "country_iso_code" varchar(3) NOT NULL);
CREATE TABLE IF NOT EXISTS "Lettings_letting" ("id" integer NOT NULL PRIMARY KEY , "title" varchar(256) NOT NULL, "address_id" bigint NOT NULL UNIQUE REFERENCES "Lettings_address" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE TABLE IF NOT EXISTS "Profiles_profile" ("id" integer NOT NULL PRIMARY KEY , "favorite_city" varchar(64) NOT NULL, "user_id" integer NOT NULL UNIQUE REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE IF NOT EXISTS "oc_lettings_site_address" ("id" integer NOT NULL PRIMARY KEY , "number" integer unsigned NOT NULL CHECK ("number" >= 0), "street" varchar(64) NOT NULL, "city" varchar(64) NOT NULL, "state" varchar(2) NOT NULL, "zip_code" integer unsigned NOT NULL CHECK ("zip_code" >= 0), "country_iso_code" varchar(3) NOT NULL);
CREATE TABLE IF NOT EXISTS "oc_lettings_site_letting" ("id" integer NOT NULL PRIMARY KEY , "title" varchar(256) NOT NULL, "address_id" bigint NOT NULL UNIQUE REFERENCES "oc_lettings_site_address" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE TABLE IF NOT EXISTS "oc_lettings_site_profile" ("id" integer NOT NULL PRIMARY KEY , "favorite_city" varchar(64) NOT NULL, "user_id" integer NOT NULL UNIQUE REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED);
